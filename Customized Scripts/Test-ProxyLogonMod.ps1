        ...
        begin {
            ...
            $scriptBlock = {
                ...
                function Get-Cve26855 {
                    [CmdletBinding()]
                    param ()
                    Write-host "Checking CVE26855" -ForegroundColor Magenta
                ...
                function Get-Cve26857 {
                    [CmdletBinding()]
                    param ()
                    Write-host "Checking CVE26857" -ForegroundColor Magenta
                    try {
                ...
                function Get-Cve26858 {
                    [CmdletBinding()]
                    param ()
                    Write-host "Checking CVE26858" -ForegroundColor Magenta
                    $exchangePath = Get-ExchangeInstallPath
                    if ($null -eq $exchangePath) {
                ...
                function Get-Cve27065 {
                    [CmdletBinding()]
                    param ()
                    Write-host "Checking CVE27065" -ForegroundColor Magenta
                    $exchangePath = Get-ExchangeInstallPath
                    if ($null -eq $exchangePath) {
